    ...
    return `
      <div class="leave-application-container">
        ...
        <div class="leave-tabs">
          <button class="leave-tab ${view === 'apply' ? 'active' : ''}" onclick="LeavePage.switchView('apply')">
            Apply Leave
          </button>
          <button class="leave-tab ${view === 'past' ? 'active' : ''}" onclick="LeavePage.switchView('past')">
            Past Applications
          </button>
        </div>
  ...
  renderApplyForm() {
    return `
      <div class="leave-apply-form">
        <form id="leaveForm" onsubmit="LeavePage.submitLeaveApplication(event)">
